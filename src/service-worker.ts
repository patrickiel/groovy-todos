...
// https://gist.github.com/khromov/6042d297f9d7ec356da1a7c85f6601c8
...
const CACHE = `groovy-cache-${version}`;
...
//       ? event.data.json()
//       : { title: 'Groovy Todos', body: 'There is new content in your Groovy Todos!' }; // Basically a fallback message in case something goes wrong
